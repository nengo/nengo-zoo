"""Tier-1 sanity tests for the spa-question-answering submission (GUI-first model)."""
...
def load_script():
    spec = importlib.util.spec_from_file_location(
        "spa_question_answering_script",
        SUBMISSION_ROOT / "spa_question_answering.py",
    )
...
def test_spa_states_present():
    """The .cfg references states A, B, C, D, E and the cortical/input modules."""
    mod = load_script()
    for attr in ("A", "B", "C", "D", "E", "cortical", "input"):
